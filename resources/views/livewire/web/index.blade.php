				...
				<div class="col-lg-6">
					...
					<div class="hero-content">
						<div class="section-title">
							...
							<h1 class="text-anime">Discover You Unique <br>& New Style</h1>
						</div>
						<div class="hero-content-body wow fadeInUp" data-wow-delay="0.5s">
							<p>We believe that your hair is an expression of your personality. Our skilled stylists are here to help you unleash your true style potential.</p>
							<ul>
		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-lg-6">
					<!-- Section Title Start -->
					<div class="section-title">
						<h3 class="wow fadeInUp">About Glimy</h3>
						<h2 class="text-anime" >Luxury Salon Where You Will Feel Unique</h2>
					</div>
					<!-- Section Title End -->
					...
					<div class="about-content wow fadeInUp" data-wow-delay="0.75s">
						...
						<ul>
							<li><span>01.</span> The hair cutting and styling with 10 years of experience.</li>
							<li><span>02.</span> Update the latest technology and tendency in the world.</li>
			...
			<div class="row align-items-center flex-column-reverse flex-lg-row">
				<div class="col-lg-6">
					...
					<div class="section-title">
						...
						<h2 class="text-anime">Are you Ready to Make a Big Change?</h2>
					</div>
					<!-- Section Title End -->
					...
					<div class="whyus-content">
						...
						<div class="whyus-feature-item wow fadeInUp" data-wow-delay="0.5s">
							<div class="whyus-icon">
								<img src="images/whyus-1.svg" alt="">
							</div>
						...
						<div class="whyus-feature-item wow fadeInUp" data-wow-delay="0.75s">
							<div class="whyus-icon">
								<img src="images/whyus-2.svg" alt="">
							</div>
	...
	<div class="pricing">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<!-- Pricing Item Start -->
					<div class="pricing-item wow fadeInUp" data-wow-delay="0.74s">
						<div class="pricing-info">
							<h3>Blow Dry & Curl</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<!-- Pricing Item Start -->
					<div class="pricing-item wow fadeInUp" data-wow-delay="1.0s">
						<div class="pricing-info">
							<h3>Shampoo & Set</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<!-- Pricing Item Start -->
					<div class="pricing-item wow fadeInUp" data-wow-delay="1.25s">
						<div class="pricing-info">
							<h3>Men's Haircut</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<!-- Pricing Item Start -->
					<div class="pricing-item wow fadeInUp" data-wow-delay="1.50s">
						<div class="pricing-info">
				...
				<div class="col-lg-4 col-md-6">
					<!-- Pricing Item Start -->
					<div class="pricing-item wow fadeInUp" data-wow-delay="1.75s">
						<div class="pricing-info">
							<h3>Natural Color</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<!-- Pricing Item Start -->
					<div class="pricing-item wow fadeInUp" data-wow-delay="2.00s">
						<div class="pricing-info">
				...
				<div class="col-lg-4 col-md-6">
					<!-- Pricing Item Start -->
					<div class="pricing-item wow fadeInUp" data-wow-delay="2.25s">
						<div class="pricing-info">
				...
				<div class="col-lg-4 col-md-6">
					<!-- Pricing Item Start -->
					<div class="pricing-item wow fadeInUp" data-wow-delay="2.50s">
						<div class="pricing-info">
				...
				<div class="col-lg-6">
					...
					<div class="gift-box">
						<div class="gift-content wow fadeInUp" data-wow-delay="0.5s">
							...
							<a href="#" class="btn-default">Get Now</a>
						</div>
